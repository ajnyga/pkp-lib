...
class PublishHandler extends Handler {
   ...
   *
    ...
    $templateMgr = TemplateManager::getManager($request);
		...
		$publicationApiUrl = $request->getDispatcher()->url($request, ROUTE_API, $submissionContext, 'submissions/' . $this->submission->getId() . '/publications/' . $this->publication->getId() . '/publish');
